...
Note that this project uses [gb](https://getgb.io) ([constabulary/gb](https://github.com/constabulary/gb)), so all the dependencies are contained here. The build artifact(s) can be found in the bin directory.
